...
function HeaderSidebar({slot,headerStore, mode  })   {
  ...
  className=" animate__animated animate__slideInLeft animate__faster fixed left-0 top-0 p-6 h-full bg-neutral-800 flex flex-col "
