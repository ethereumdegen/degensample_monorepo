  ...
  theme: {
    extend: {
      colors: {
        ...
        'deep-indigo': '#3b5dc9', // Blue One
        'electric-purple': '#29366f', // Muted Purple
        'teal-accent': '#789aac', // Steel Blue
        'navy-blue': '#0D1B3E',
        'cool-gray': '#F5F7FA',
        'slate-custom': '#64748B',
      ...
      fontFamily: {
        // Design system fonts from DESIGN_SPEC.md
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(to right, #3A1D8C, #7C4DFF)',
      },
      spacing: {
        '18': '4.5rem',
      }
